...
$KDADMDIRECTORY/kcadm.sh add-roles -r dev --uusername winra_admin --cclientid pki-ra-client-public --rolename SUPER_ADMIN
$KDADMDIRECTORY/kcadm.sh add-roles -r dev --uusername winra_admin --cclientid realm-management --rolename realm-admin
$KDADMDIRECTORY/kcadm.sh add-roles -r master --uusername winra_admin --cclientid realm-management --rolename realm-admin
